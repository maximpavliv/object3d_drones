function vis_fp(img, opt_fp, opt_wp, heatmap, center, scale, K, cad)
    ...
    img_heatmap = mapIm*0.5 + (single(img_crop)/255)*0.5;
    imagesc(img_heatmap); axis equal off
    ...
    imshow(img_crop); hold on;
    patch('vertices',mesh2d_fp','faces',model_fp.faces,'FaceColor','green','FaceAlpha',0.3,'EdgeColor','none');
